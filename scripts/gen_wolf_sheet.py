"""
Generates assets/overworld_objects/wolf/sheet.png and sprite.png.

4-facing oblique quadruped on scripts/char_rig.py (see docs/sprite_style.md):
frame 96×64, sheet 4 cols × 8 rows (idle_s … walk_w). A wild grey-brown
forest wolf — earthier than the spectral summoned_wolf so the two read as
different creatures at a glance. sprite.png is the static south idle
fallback.
"""
...
FRAME_W = 96
FRAME_H = 64
OUT_DIR = "assets/overworld_objects/wolf"

FUR = triple((110, 104, 96, 255))       # grey-brown coat
FUR_DARK = triple((72, 66, 60, 255))
BELLY = triple((156, 150, 140, 255))
MUZZLE = triple((58, 52, 46, 255))

EYE_WHITE = (232, 214, 150, 255)        # amber hunter's stare
PUPIL = (34, 28, 22, 255)
