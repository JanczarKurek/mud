...
use mud2::ui::settings::{EditorAction, EditorKeybindings};
...
pub fn fragment_from_selection(
    ...
    for (object_id, tile, contents) in objects {
        ...
        if mud2::world::components::floor_index(tile.z) != active_floor_index {
            continue;
        }
...
pub fn stamp_fragment(
    ...
    object_definitions: &mud2::world::object_definitions::OverworldObjectDefinitions,
    world_config: &mud2::world::WorldConfig,
    ...
    for fo in &fragment.objects {
        ...
        let entity = mud2::world::setup::spawn_overworld_object(
            commands,
            object_definitions,
            object_registry,
            new_id,
...
pub fn render_paste_ghost(
    ...
    world_config: Res<mud2::world::WorldConfig>,
    editor_camera: Res<crate::editor::resources::EditorCamera>,
    editor_context: Res<EditorContext>,
    editor_state: Res<EditorState>,
    clipboard: Res<EditorClipboard>,
    object_definitions: Res<mud2::world::object_definitions::OverworldObjectDefinitions>,
    ...
    for fo in &fragment.objects {
        ...
        let mut bundle = mud2::world::setup::build_object_visual_bundle(
            &asset_server,
        ...
        let z_base = if def.render.y_sort {
            mud2::world::systems::y_sort_z(tile.x + fo.dx, tile.y + fo.dy, active_floor_index, 0, 0)
        } else {
...
mod tests {
    ...
    fn fragment_yaml_round_trip_preserves_behavior() {
        use mud2::world::map_layout::{MapBehavior, TileRectangle};
    ...
    fn fragment_from_selection_relative_coords() {
        use mud2::world::floor_map::FloorMap;
