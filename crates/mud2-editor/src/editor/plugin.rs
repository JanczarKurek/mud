...
use mud2::world::animation::AnimatedSprite;
use mud2::world::components::{
    ClientProjectedWorldObject, ClientRemotePlayerVisual, OverworldObject, WorldVisual,
};
use mud2::world::resources::{ClientRemotePlayerProjectionState, ClientWorldProjectionState};
...
impl Plugin for EditorPlugin {
    fn build(&self, app: &mut App) {
        ...
        let presets = mud2::world::building_presets::BuildingPresets::load_from_disk();
        {
            let world = app.world();
            let object_defs =
                world.get_resource::<mud2::world::object_definitions::OverworldObjectDefinitions>();
            let floor_defs =
                world.get_resource::<mud2::world::floor_definitions::FloorTilesetDefinitions>();
        ...
        app.init_resource::<EditorState>()
            ...
            .add_systems(
                ...
                (
                    ...
                    .chain()
                    .after(mud2::game::CommandIntercept)
