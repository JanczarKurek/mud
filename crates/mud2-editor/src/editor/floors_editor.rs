...
//! rules (`mud2::world::floors`) but sources the "viewer" from the editor
...
use mud2::world::components::{floor_index, OverworldObject, SpaceId, SpaceResident, TilePosition};
use mud2::world::floor_definitions::FloorTilesetDefinitions;
use mud2::world::floor_map::FloorMaps;
use mud2::world::floors::{floormap_tile_occludes, VisibleFloorRange, MAX_FLOORS_ABOVE};
...
mod tests {
    ...
    use mud2::world::floor_definitions::{
