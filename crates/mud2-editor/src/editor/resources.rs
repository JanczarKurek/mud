...
use mud2::world::components::{SpaceId, TilePosition};
use mud2::world::floor_definitions::{derive_floor_id, FloorFlavor, FloorTypeId};
...
impl EditorState {
    ...
    pub fn tile_on_active_floor(&self, tile_z: i32) -> bool {
        mud2::world::components::floor_index(tile_z) == self.current_editing_floor
    }
}
...
pub struct EditorSpaceResetDeps<'w, 's> {
    pub spawn_group_registry: ResMut<'w, mud2::npc::spawn_groups::SpawnGroupRegistry>,
    pub residents: Query<
        'w,
        's,
        (
            bevy::prelude::Entity,
            &'static mud2::world::components::SpaceResident,
        ),
...
pub struct EditorViewState<'w> {
    ...
    pub world_config: ResMut<'w, mud2::world::WorldConfig>,
}
