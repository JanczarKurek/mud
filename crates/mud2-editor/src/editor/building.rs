...
use mud2::world::building_presets::{BuildingPreset, BuildingPresets, WallSlots};
...
use mud2::world::setup::spawn_overworld_object;
...
mod tests {
    ...
    fn fragment_covers_perimeter_and_interior() {
        let sel = EditorSelection {
            space_id: mud2::world::components::SpaceId(0),
