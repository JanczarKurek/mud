...
pub fn handle_save_button_click(
    ...
    mut object_registry: ResMut<mud2::world::object_registry::ObjectRegistry>,
    floor_maps: Res<mud2::world::floor_map::FloorMaps>,
    objects: Query<
        (
            &mud2::world::components::OverworldObject,
            &mud2::world::components::SpaceResident,
            &mud2::world::components::TilePosition,
            Option<&mud2::world::components::Container>,
        ),
        (
            bevy::prelude::Without<mud2::npc::components::SpawnGroupMember>,
            bevy::prelude::Without<mud2::player::components::Player>,
        ),
    >,
    mut space_definitions: ResMut<mud2::world::map_layout::SpaceDefinitions>,
) {
...
pub fn handle_generate_dungeon_button_click(
    ...
    mut modal_state: ResMut<ModalState>,
    floor_defs: Res<mud2::world::floor_definitions::FloorTilesetDefinitions>,
    object_defs: Res<mud2::world::object_definitions::OverworldObjectDefinitions>,
) {
    for interaction in &btn {
        if *interaction == Interaction::Pressed && modal_state.active.is_none() {
...
pub fn handle_exit_button_click(
    ...
    mut next_state: ResMut<NextState<mud2::app::state::ClientAppState>>,
) {
    for interaction in &btn {
        if *interaction == Interaction::Pressed {
            next_state.set(mud2::app::state::ClientAppState::TitleScreen);
        }
    }
}
