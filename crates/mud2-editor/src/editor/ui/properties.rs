...
use mud2::world::components::{OverworldObject, Quantity, TilePosition};
...
pub fn sync_properties_panel(
    ...
    container_query: Query<(&OverworldObject, &mud2::world::components::Container)>,
...
pub fn handle_stack_slider_drag(
    ...
    if mouse.just_pressed(MouseButton::Left) {
        ...
        if !mud2::ui::movable_window::point_in_node(cursor, computed, transform) {
            return;
        }
        drag.active = true;
    }
