...
- `assets/floors/flagstone/metadata.yaml` (tileset generated by `scripts/gen_floor_tilesets.py`)
- `assets/floors/checkered_marble/metadata.yaml` (tileset generated by `scripts/gen_floor_tilesets.py`)
